			...
			<div class="card-body">
				<div class="col-md-12">
					...
					<div class="row" id="printable">
						<div id="onPrint">
							<p class="text-center">Student List and Details</p>
							<hr>
						...
						<table class="table table-bordered">
							<thead>
								...
								<th class="text-center">Student_LRN</th>
				...
				if(resp){
					...
					if(!!resp.data && Object.keys(resp.data).length > 0){
						...
						Object.keys(resp.data).map(k=>{
							...
							tr.append('<td class="">'+resp.data[k].section+'</td>')
							tr.append('<td class="">'+resp.data[k].student_lrn+'</td>')
